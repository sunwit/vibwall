...
print(good_acc_gyro_1.shape, good_acc_gyro_11.shape, good_acc_gyro_2.shape, good_acc_gyro_22.shape, good_acc_gyro_3.shape, good_acc_gyro_33.shape)
...
plt.savefig('plot_umap_mfcc_three.pdf')
