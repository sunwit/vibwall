...
good_acc_gyro_con = np.concatenate([good_acc_gyro_1, good_acc_gyro_11,  good_acc_gyro_2, good_acc_gyro_22, good_acc_gyro_3, good_acc_gyro_33], axis=0)
...
bad_acc_gyro_con = np.concatenate([bad_acc_gyro_1, bad_acc_gyro_11, bad_acc_gyro_2, bad_acc_gyro_22,  bad_acc_gyro_3, bad_acc_gyro_33], axis=0)
