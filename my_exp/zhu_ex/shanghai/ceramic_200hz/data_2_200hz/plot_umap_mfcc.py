...
good_file_1=open('./good_wall_mfcc.pkl', 'rb')
good_acc_gyro_1=pickle.load(good_file_1)
#good_acc_gyro_con = np.concatenate([good_acc_gyro_1, good_acc_gyro_11[:,:,1:5,:,:],  good_acc_gyro_2[:,:,1:5,:,:], good_acc_gyro_22[:,:,1:5,:,:], good_acc_gyro_3[:,:,1:5,:,:], good_acc_gyro_33[:,:,1:5,:,:]], axis=0)
good_acc_gyro_con = good_acc_gyro_1
...
bad_file_1=open('./bad_wall_mfcc.pkl', 'rb')
bad_acc_gyro_1=pickle.load(bad_file_1)
#bad_acc_gyro_con = np.concatenate([bad_acc_gyro_1[:,:,1:5,:,:], bad_acc_gyro_11[:,:,1:5,:,:], bad_acc_gyro_2[:,:,1:5,:,:], bad_acc_gyro_22[:,:,1:5,:,:], bad_acc_gyro_3[:,:,1:5,:,:], bad_acc_gyro_33[:,:,1:5,:,:]], axis=0)
bad_acc_gyro_con = bad_acc_gyro_1
...
plt.savefig('umap_mfcc_sample_rate_200.pdf')
