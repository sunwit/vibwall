...
good_file_1=open('../../../../office_wall/good_wall_mfcc.pkl', 'rb')
good_file_2=open('../../../../office_wall/TestData_1/good_wall_mfcc.pkl', 'rb')
good_acc_gyro_1=pickle.load(good_file_1)
good_acc_gyro_2=pickle.load(good_file_2)
good_acc_gyro_con = np.concatenate([good_acc_gyro_1, good_acc_gyro_2], axis=0)
...
bad_file_1=open('../../../../office_wall/bad_wall_mfcc.pkl', 'rb')
bad_file_2=open('../../../../office_wall/TestData_1/bad_wall_mfcc.pkl', 'rb')
bad_acc_gyro_1=pickle.load(bad_file_1)
bad_acc_gyro_2=pickle.load(bad_file_2)
bad_acc_gyro_con = np.concatenate([bad_acc_gyro_1, bad_acc_gyro_2], axis=0)
...
plt.savefig('umap_mfcc_sample_rate_100.pdf')
